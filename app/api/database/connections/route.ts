...
const createConnectionSchema = z.object({
  ...
  connectionString: z.string().max(2000).nullable().optional(),
  config: z.record(z.string(), z.unknown()).optional(),
  supabaseUrl: z.string().max(500).nullable().optional(),
  supabaseAnonKey: z.string().max(500).nullable().optional(),
  supabaseServiceKey: z.string().max(500).nullable().optional(),
  host: z.string().max(253).nullable().optional(),
  port: z.number().int().min(1).max(65535).nullable().optional(),
  database: z.string().max(100).nullable().optional(),

...
import { Check, Sparkles, Zap, Rocket, Crown, ArrowLeft } from "lucide-react";
...
export default function PricingPage() {
  ...
  const handleSelectPlan = (tier: string) => {
    ...
    if (tier === "Business") {
      window.location.href = "mailto:sales@shipfast.com?subject=Business Plan Inquiry";
    } else if (tier === "Pro") {
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-700 shadow-sm"
        >
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Build Your Apps Faster?
          </h2>

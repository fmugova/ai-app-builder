    ...
    <div id=\"root\">
        <header class=\"py-20 px-4\">
            <div class=\"max-w-4xl mx-auto text-center\">
                ...
                <div class=\"flex gap-4 justify-center\">
                    <button class=\"px-6 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg transition\">View Work</button>
                    <button class=\"px-6 py-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition\">Contact Me</button>
                </div>
            </div>
        </header>
        <section class=\"py-20 px-4 bg-gray-800\">
            <div class=\"max-w-7xl mx-auto\">
                ...
                <div class=\"grid md:grid-cols-2 lg:grid-cols-3 gap-8\">
                    <div class=\"bg-gray-900 rounded-xl overflow-hidden hover:transform hover:scale-105 transition\">
                        <div class=\"h-48 bg-gradient-to-br from-purple-500 to-blue-500\"></div>
                        <div class=\"p-6\">
                            <h3 class=\"text-xl font-bold mb-2\">Project One</h3>
                            <p class=\"text-gray-400 mb-4\">A modern web application built with React and Node.js</p>
                            <div class=\"flex gap-2\">
                                <span class=\"px-3 py-1 bg-purple-900 text-purple-300 rounded-full text-sm\">React</span>
                                <span class=\"px-3 py-1 bg-blue-900 text-blue-300 rounded-full text-sm\">Node.js</span>
                            </div>
                        </div>
                    </div>
                    <div class=\"bg-gray-900 rounded-xl overflow-hidden hover:transform hover:scale-105 transition\">
                        <div class=\"h-48 bg-gradient-to-br from-green-500 to-teal-500\"></div>
                        <div class=\"p-6\">
                            <h3 class=\"text-xl font-bold mb-2\">Project Two</h3>
                            <p class=\"text-gray-400 mb-4\">E-commerce platform with advanced features</p>
                            <div class=\"flex gap-2\">
                                <span class=\"px-3 py-1 bg-green-900 text-green-300 rounded-full text-sm\">Vue.js</span>
                                <span class=\"px-3 py-1 bg-teal-900 text-teal-300 rounded-full text-sm\">MongoDB</span>
                            </div>
                        </div>
                    </div>
                    <div class=\"bg-gray-900 rounded-xl overflow-hidden hover:transform hover:scale-105 transition\">
                        ...
                        <div class=\"p-6\">
                            ...
                            <p class=\"text-gray-400 mb-4\">Mobile app for iOS and Android platforms</p>
                            <div class=\"flex gap-2\">
                                <span class=\"px-3 py-1 bg-orange-900 text-orange-300 rounded-full text-sm\">React Native</span>
                                <span class=\"px-3 py-1 bg-red-900 text-red-300 rounded-full text-sm\">Firebase</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=\"max-w-4xl mx-auto\">
                ...
                <div class=\"grid md:grid-cols-2 gap-6\">
                    <div class=\"p-6 bg-gray-800 rounded-xl\">
                        ...
                        <div class=\"space-y-3\">
                            <div class=\"flex justify-between items-center\"><span>React / Next.js</span><span class=\"text-purple-400\">Expert</span></div>
                            <div class=\"flex justify-between items-center\"><span>TypeScript</span><span class=\"text-purple-400\">Advanced</span></div>
                            <div class=\"flex justify-between items-center\"><span>Tailwind CSS</span><span class=\"text-purple-400\">Expert</span></div>
                        </div>
                    </div>
                    <div class=\"p-6 bg-gray-800 rounded-xl\">
                        <h3 class=\"text-xl font-bold mb-4\">Backend Development</h3>
                        <div class=\"space-y-3\">
                            <div class=\"flex justify-between items-center\"><span>Node.js / Express</span><span class=\"text-blue-400\">Expert</span></div>
                            <div class=\"flex justify-between items-center\"><span>PostgreSQL / MongoDB</span><span class=\"text-blue-400\">Advanced</span></div>
                            <div class=\"flex justify-between items-center\"><span>API Design</span><span class=\"text-blue-400\">Expert</span></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class=\"py-20 px-4 bg-gray-800\">
            <div class=\"max-w-3xl mx-auto text-center\">
                ...
                <button class=\"px-8 py-4 bg-purple-600 hover:bg-purple-700 rounded-lg transition font-medium text-lg\">Get In Touch</button>
            </div>
        </section>
        <footer class=\"py-8 px-4 bg-gray-900\">
            <div class=\"max-w-7xl mx-auto text-center text-gray-400\">
                <p>© 2026 John Doe. Built with passion.</p>
            </div>
        </footer>
    </div>
</body>
            ...
            <div class=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8\">
                <div class=\"flex justify-between items-center h-16\">
                    ...
                    <div class=\"hidden md:flex items-center gap-8\">
                        ...
                        <button class=\"px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition font-medium\">Get Started</button>
                    </div>
                </div>
            </div>
        </nav>
